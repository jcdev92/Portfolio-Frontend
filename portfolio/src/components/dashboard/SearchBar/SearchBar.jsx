    ...
    <div className="pb-4 bg-transparent backdrop-blur-sm dark:bg-gray-900">
      ...
      <div className="relative mt-1">
        ...
        <input
          ...
          onChange={search}
          id="table-search"
          className="block bg-transparent text-white p-2 pl-10 text-sm text-gray-900 border border-sky-400/50  rounded-lg w-80 bg-gray-50 placeholder-sky-400/50 focus:ring-blue-500 focus:border-blue-500"
          placeholder="Search"
        />
      </div>
    </div>
