    ...
    <div className="w-5/6 h-5/6 backdrop-blur-sm p-6 rounded-md shadow-md">
      ...
      <form className="h-full w-full flex flex-col items-center justify-center p-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="h-3/4 w-full overflow-y-auto scrollbar scrollbar-thin scrollbar-track-rounded-lg scrollbar-thumb-rounded-lg scrollbar-thumb-sky-600 scrollbar-track-transparent p-4 rounded-lg">
          ...
          <label
            htmlFor="description"
            className="block mb-2 text-sm font-medium text-white dark:text-white p-1"
          >
            Description
          </label>
          <textarea
            id="description"
            rows="4"
            className="block p-2.5 w-11/12 text-sm text-white bg-transparent rounded-lg border border-gray-300 placeholder-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
