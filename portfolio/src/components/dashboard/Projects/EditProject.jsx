...
export const EditProject = ({ setEditMode, selectedId, keyword }) => {
  ...
  return (
    <div className="w-5/6 h-5/6 backdrop-blur-md overflow-y-auto scrollbar scrollbar-thin scrollbar-track-rounded-lg scrollbar-thumb-rounded-lg scrollbar-thumb-sky-600 scrollbar-track-transparent rounded-md shadow-md">
      <form className="pr-2" onSubmit={handleSubmit(onSubmit)}>
        <div className="p-4 w-full flex rounded-md flex-col bg-indigo-950 opacity-95 sticky inset-0 z-30">
        ...
        <div className="px-12">
          {isLoading ? (
            ...
            <div>
              <h6 className="text-2xl py-4 uppercase">
