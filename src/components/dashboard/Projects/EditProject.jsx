      ...
      <form className="pr-2 w-full h-full" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="p-6 pt-0 h-4/5 font-exo">
          {isLoading ? (
            ...
            <div className="p-6 pt-1 h-5/6 overflow-y-auto scrollbar-thin scrollbar-track-rounded-lg scrollbar-thumb-rounded-lg scrollbar-thumb-blue-600 scrollbar-track-transparent rounded-md">
